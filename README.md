...
Elang Game Engine is a work-in-progress generic 2d game engine. It's a project being crafted mostly for programming experience, but also to make a lightweight alternative to common game engines, providing some 2d game design mechanics that are not readily available in the market. The source is tailor written, possibly offering everything it can to help make publishable games in the future.
